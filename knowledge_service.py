...
#os.environ["HF_ENDPOINT"] = "https://hf-mirror.com"
#os.environ["HUGGINGFACE_HUB_ENDPOINT"] = "https://hf-mirror.com"
MILVUS_DB_PATH = "./milvus_travel.db"
...
def index_travel_data(docs: Optional[List[str]] = None):
    ...
    client.create_collection(collection_name=COLLECTION_NAME, schema=schema)#dimension=EMBEDDING_DIM, auto_id=False,
                             #schema={"fields": [
...
def get_retriever_tool():
    ...
    def search_knowledge(query: str, k: int = 3) -> List[str]:
        ...
        results = client.search(collection_name=COLLECTION_NAME, data=[query_vector],
